...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var prod1 = multiply(multiply(a, b)[0],c)[0];
  var sumString = a + ' and ' + b + ' and ' + c + ' sum to ' + sum1 + '.';
  var prodString = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + prod1 + '.';
  return [sum1, prod1, sumString, prodString];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (var i in dynamicArray) {
    product3 = multiply(product3, dynamicArray[i])[0];
    prod3String += dynamicArray[i] + ',';
  }
  prod3String = 'The numbers ' + prod3String.substring(0, prod3String.length - 1) + ' have a product of ' + product3 + '.';
  return [product3, prod3String];
}
